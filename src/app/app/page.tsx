...
export default function AppShell() {
  return (
    <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 py-8 sm:py-12 flex flex-col gap-8">
      {/* Dashboard Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-foreground mb-1">Dashboard</h1>
          <p className="text-sm text-foreground-muted">Create on-chain proofs for your off-chain actions.</p>
        </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 items-start">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <Card className="flex flex-col gap-6">
            <div>
              <h2 className="text-lg font-semibold text-foreground mb-1">Create New Proof</h2>
              <p className="text-sm text-foreground-muted">Select an action type to generate a verifiable proof.</p>
            </div>
            
            {/* Action Type Selection */}
            <div className="flex flex-col gap-3">
              <label className="text-xs font-semibold uppercase tracking-wider text-foreground-muted">Action Type</label>
              <div className="grid sm:grid-cols-2 gap-3">
                ...
                <div className="border-2 border-base-blue bg-base-blue/5 rounded-xl p-4 cursor-pointer transition-all relative overflow-hidden">
                  ...
                  <div className="flex items-start gap-3 relative z-10">
                    ...
                    <div>
                      <div className="font-semibold text-sm text-foreground mb-0.5">GitHub Contribution</div>
                      <div className="text-xs text-foreground-muted leading-relaxed">Prove a PR merge or commit</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="border border-border-subtle bg-surface hover:bg-surface-hover hover:border-border rounded-xl p-4 cursor-pointer transition-all opacity-60">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-sm text-foreground mb-0.5">X (Twitter) Post</div>
                      <div className="text-xs text-foreground-muted leading-relaxed">Coming soon</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Input Form */}
            <div className="flex flex-col gap-3">
              <label className="text-xs font-semibold uppercase tracking-wider text-foreground-muted">Action Link</label>
              ...
              <p className="text-xs text-foreground-muted">Provide the exact public URL of the PR or commit you want to verify.</p>
            </div>
        ...
        <div className="lg:col-span-1 flex flex-col gap-6">
          <Card className="flex flex-col h-[400px]">
            <h2 className="text-base font-semibold text-foreground mb-4">Recent Proofs</h2>
            ...
            <div className="flex-grow flex flex-col items-center justify-center text-center px-4">
              ...
              <h3 className="text-sm font-medium text-foreground mb-1">No proofs found</h3>
